...
import zxjpa.cache.annotation.Cache;
import zxjpa.cache.model.CacheModel;
import zxjpa.jpa.annotation.Id;
import zxjpa.jpa.annotation.Model;
import zxjpa.jpa.annotation.Transient;
import zxjpa.jpa.annotation.Version;
...
//		else {
//			if(!cls.startsWith("zxjpa")) {//并非自身程序的对象
