...
//	public static boolean eopen=false;
	...
	public static void loadZxJpaConfig() {
		 //1.获取jaxp工厂  
        ...
        try {  
            ...
            Document document = builder.parse(new File(ClassLoader.getSystemResource("zxjpa.xml").getPath()));  
            //4.获得zxjpa
